...
INSERT INTO CrimeEvent (event_id, occurrence_time_id, reported_time_id, crime_id, hood_id, latitude, longitude, premise_type) values (2,100000,300033,600008,600008,-79.3867874,43.6702271, "Other");
INSERT INTO CrimeEvent (event_id, occurrence_time_id, reported_time_id, crime_id, hood_id, latitude, longitude, premise_type) values (3,100005,300071,600008,600008,-79.3436279,43.7074776, "Commercial");
...
INSERT INTO BikeTheft (bike_theft_id, colour, make, model, speed, bike_type, status, cost) values (100001,"BLK","MONGOOSE", 18, "mt", "STOLEN", 200);
INSERT INTO BikeTheft (bike_theft_id, colour, make, model, speed, bike_type, status, cost) values (100001,"BLK","NORCO", 24, "ot", "STOLEN", 600);
-- INSERT INTO InvolvedPerson;
INSERT INTO InvolvedPerson (accident_id, person_id, involvement_type, age, injury, vehicle_type, action_taken) values (900001, 500001,"Cyclist", 21, "minimal", "car", "none");
INSERT INTO InvolvedPerson (accident_id, person_id, involvement_type, age, injury, vehicle_type, action_taken) values (900002, 500002,"Driver", 34, "major", "car", "none");
INSERT INTO InvolvedPerson (accident_id, person_id, involvement_type, age, injury, vehicle_type, action_taken) values (900003, 500003,"Vehicle Owner", 55, "none", "car", "none");
